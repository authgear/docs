...
Your end-users can now sign in with Google on Authgear pre-built Log In and Sign Up page. Existing end-users can connect their account to Google in the [User Settings](../../../customization/ui-customization/built-in-ui/user-settings.md) page.
