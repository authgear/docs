...
* [**OAuth 2.0 and OpenID Connect**](../../api-reference/apis/oauth-2.0-and-openid-connect-oidc): for connecting with OIDC Clients
...
{% content-ref url="../../api-reference/apis/oauth-2.0-and-openid-connect-oidc" %}
[oauth-2.0-and-openid-connect-oidc](../../api-reference/apis/oauth-2.0-and-openid-connect-oidc)
{% endcontent-ref %}
