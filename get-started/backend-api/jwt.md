...
See the claims in the access token in this reference: [jwt-access-token.md](../../reference/tokens/jwt-access-token.md "mention"). Learn more about [add-custom-fields-to-a-jwt-access-token.md](../../admin/user-profiles/add-custom-fields-to-a-jwt-access-token.md "mention") for adding claims into the JWT.
