...
Both options need the following, in addition to the VMs listed in their inventories.

| Item             | Quantity          | Remarks                                                                                                                                                                                                                                         |
| ---------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| IP address       | 1                 | For the load balancer.                                                                                                                                                                                                                          |
...
| Grafana hostname | 1                 | Internal hostname and certificate. Grafana is not exposed to the internet, so it does not use the public domains or the wildcard certificate. Not needed when Option 1 omits the monitor VM.                                                    |
| Firewall         | 1                 | In front of the load balancer.                                                                                                                                                                                                                  |
...
Throughput is bound by the database, not by the number of Authgear VMs, so the second Authgear VM adds availability, not capacity. The architecture therefore fixes Authgear at two VMs, enough for failover and rolling upgrades. A third would add nothing.
